...
func (p *tarballImageProvider) Provide(ctx context.Context, path string, metadata ...image.AdditionalMetadata) (*image.Image, error) {
	...
	return NewDirectoryProvider(p.tmpDirGen).Provide(ctx, tempDir, metadata...)
}
