...
type WalkConditions struct {
	...
	// Whether we should visit the current node. Note: this will continue down the same traversal path, only "skipping" over a single node (but still potentially visiting children later)
